...
// ======== Simple helpers ========
// 1-bit GEMM: C = A x B, both A and B are bit-packed along K into 32-bit words

static const char* kShaderGLSL = R"(
#version 450
...
int main(){
    ...
    dsai.pSetLayouts=&vk.dsetLayout;
    VkDescriptorSet dset; 
    vkAllocateDescriptorSets(vk.dev, &dsai, &dset);
